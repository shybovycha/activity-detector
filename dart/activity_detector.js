...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "DOMImplementation|DeviceAcceleration|MediaError|MediaKeyError|PositionError|Range|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
...
["", "activity_detector.dart", , S, {
  "^": "",
  ActivityMatcher_match: function(data) {
    return C.JSArray_methods.firstWhere$1($.get$ActivityMatcher_activityPatterns(), new S.ActivityMatcher_match_closure(data));
  },
  main: [function() {
    var motionListener, t1, sendButtons;
    motionListener = new S.MotionListener(document.querySelector("#activity_name"), null, null, null, null, 5000);
    motionListener.accelData = S.AccelerometerData$blank();
    motionListener.firstTimestamp = new P.DateTime(Date.now(), false);
    motionListener.tracker = S.MotionTracker$();
    t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "devicemotion", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(motionListener.get$handle()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    sendButtons = new W._FrozenElementList(document.querySelectorAll(".btn.send[data-activity]"));
    for (t1 = sendButtons.get$iterator(sendButtons); t1.moveNext$0();)
      J.get$onClick$x(t1._current).listen$1(motionListener.get$flush());
  ...
  AccelerometerData: {
    ...
    AccelerometerData$blank$0: function() {
      ...
      this.ys = H.setRuntimeTypeInfo([], [P.$double]);
      this.zs = H.setRuntimeTypeInfo([], [P.$double]);
    },
    static: {AccelerometerData$blank: function() {
        var t1 = new S.AccelerometerData(null, null, null, null);
        t1.AccelerometerData$blank$0();
        return t1;
      }}
  },
  TimestampedAxisData: {
  ...
  AxisDataParams: {
    ...
    findTimestampedHeaps$2: function(timestamps, axisData) {
      ...
      res = [];
      for (i = 0; i < len; ++i) {
        if (i >= axisData.length)
          return H.ioore(axisData, i);
        if (J.$lt$n(J.abs$0$n(J.$sub$n(J.abs$0$n(axisData[i]), maxHeap)), 5)) {
          if (i >= timestamps.length)
            return H.ioore(timestamps, i);
          t1 = timestamps[i];
          if (i >= axisData.length)
            return H.ioore(axisData, i);
          res.push(new S.TimestampedAxisData(axisData[i], t1));
        }
      }
      return res;
    },
    findHeapFrequency$1: function(timestampedAxisData) {
      var timestampDiffsSum, timestampDiffsCnt, i, diff, t1;
      for (timestampDiffsSum = 0, timestampDiffsCnt = 0, i = 1; i < timestampedAxisData.length; ++i) {
        diff = J.$sub$n(timestampedAxisData[i].timestamp, timestampedAxisData[i - 1].timestamp);
        t1 = J.getInterceptor$n(diff);
        if (t1.$ge(diff, 100) && t1.$le(diff, 1500)) {
    ...
    AxisDataParams$fromAxisData$2: function(timestamps, axisData) {
      this.frequency = this.findHeapFrequency$1(this.findTimestampedHeaps$2(timestamps, axisData));
      this.amplitude = this.findHeapAmplitude$1(axisData);
    },
    static: {AxisDataParams$: function(frequency, amplitude) {
        return new S.AxisDataParams(frequency, amplitude);
      }, AxisDataParams$fromAxisData: function(timestamps, axisData) {
        var t1 = new S.AxisDataParams(null, null);
        t1.AxisDataParams$fromAxisData$2(timestamps, axisData);
        return t1;
      }}
  },
  AxisDataParams_findTimestampedHeaps_closure: {
    "^": "Closure:5;",
    call$2: function(acc, elt) {
      var t1 = J.getInterceptor$n(elt);
      return J.$gt$n(t1.abs$0(elt), acc) ? t1.abs$0(elt) : acc;
    }
  },
  AxisDataParams_findHeapAmplitude_closure: {
    "^": "Closure:5;",
    call$2: function(acc, elt) {
      var t1 = J.getInterceptor$n(elt);
      return J.$lt$n(t1.abs$0(elt), acc) ? t1.abs$0(elt) : acc;
    }
  },
  AxisDataParams_findHeapAmplitude_closure0: {
    "^": "Closure:5;",
    call$2: function(acc, elt) {
      var t1 = J.getInterceptor$n(elt);
      return J.$gt$n(t1.abs$0(elt), acc) ? t1.abs$0(elt) : acc;
  ...
  AxesData: {
    ...
    AxesData$fromAccelerometerData$1: function(data) {
      ...
      this.yParams = S.AxisDataParams$fromAxisData(data.timestamps, data.ys);
      this.zParams = S.AxisDataParams$fromAxisData(data.timestamps, data.zs);
    },
    static: {AxesData$fromAccelerometerData: function(data) {
        var t1 = new S.AxesData(null, null, null);
        t1.AxesData$fromAccelerometerData$1(data);
        return t1;
      }}
  },
  ActivityPattern: {
    "^": "AxesData;name>",
    matches$1: function(_, params) {
      throw H.wrapException(P.Exception_Exception("Not implemented"));
    }
  },
  RunningPattern: {
    "^": "ActivityPattern;name,xParams,yParams,zParams",
    matches$1: function(_, params) {
      var xps, yps, zps, t1;
      xps = params.xParams;
      yps = params.yParams;
      ...
      if (typeof t1 !== "number")
        return t1.$ge();
      if (t1 >= 2.5)
        if (J.$ge$n(xps.amplitude, 34)) {
          t1 = yps.frequency;
          if (typeof t1 !== "number")
            return t1.$ge();
          if (t1 >= 3)
            if (J.$ge$n(yps.amplitude, 35)) {
              t1 = zps.frequency;
              if (typeof t1 !== "number")
                return t1.$ge();
              t1 = t1 >= 1.9 && J.$ge$n(zps.amplitude, 35);
            } else
              t1 = false;
          else
            t1 = false;
        ...
        if (J.$ge$n(xps.amplitude, 25)) {
          ...
          if (t1 >= 1.5)
            if (J.$ge$n(yps.amplitude, 35)) {
              ...
              if (typeof t1 !== "number")
                return t1.$ge();
              t1 = t1 >= 2.5 && J.$ge$n(zps.amplitude, 35);
            } else
              t1 = false;
          else
            t1 = false;
  ...
  WalkingPattern: {
    ...
    matches$1: function(_, params) {
      ...
      if (typeof t1 !== "number")
        return t1.$ge();
      if (t1 >= 2)
        if (J.$ge$n(xps.amplitude, 15)) {
          t1 = yps.frequency;
          if (typeof t1 !== "number")
            return t1.$ge();
          if (t1 >= 5)
            if (J.$ge$n(yps.amplitude, 10)) {
              t1 = zps.frequency;
              if (typeof t1 !== "number")
                return t1.$ge();
              t1 = t1 >= 5 && J.$ge$n(zps.amplitude, 10);
            } else
              t1 = false;
          else
            t1 = false;
        ...
        if (J.$ge$n(xps.amplitude, 10)) {
          ...
          if (t1 >= 8)
            if (J.$ge$n(yps.amplitude, 10)) {
              ...
              if (typeof t1 !== "number")
                return t1.$ge();
              t1 = t1 >= 8 && J.$ge$n(zps.amplitude, 10);
            } else
              t1 = false;
          else
            t1 = false;
  ...
  SittingPattern: {
    ...
    matches$1: function(_, params) {
      ...
      if (typeof t1 !== "number")
        return t1.$ge();
      if (t1 >= 5)
        if (J.$gt$n(xps.amplitude, 0)) {
          t1 = yps.frequency;
          if (typeof t1 !== "number")
            return t1.$ge();
          if (t1 >= 5)
            if (J.$gt$n(yps.amplitude, 0)) {
              t1 = zps.frequency;
              if (typeof t1 !== "number")
                return t1.$ge();
              t1 = t1 >= 2 && J.$gt$n(zps.amplitude, 0);
            } else
              t1 = false;
          else
            t1 = false;
  ...
  ActivityMatcher_match_closure: {
    "^": "Closure:6;_captured_data_0",
    call$1: function(pattern) {
      return J.matches$1$x(pattern, this._captured_data_0);
    }
  },
  MotionTracker: {
    "^": "Object;accelData,axesData,label",
    flush$1: function(label) {
      var request, t1;
      this.label = label;
    ...
    toJson$0: function() {
      ...
      if (typeof console != "undefined")
        console.log($self);
      window;
      t1 = C.JsonCodec_null_null.encode$1($self);
      if (typeof console != "undefined")
        console.log(t1);
    ...
    static: {MotionTracker$: function() {
        var t1 = new S.MotionTracker(null, null, null);
        t1.MotionTracker$0();
        return t1;
      }}
  },
  ...
  MotionListener: {
    "^": "Object;activityNamePanel,infoPanel,accelData,firstTimestamp,tracker,DATA_LIFE_TIME",
    flush$1: [function(e) {
    ...
    handle$1: [function(e) {
      ...
      z = t1.z;
      try {
        this.accelData.timestamps.push(ts);
        this.accelData.xs.push(x);
        this.accelData.ys.push(y);
        this.accelData.zs.push(z);
        params = S.AxesData$fromAccelerometerData(this.accelData);
        pattern = S.ActivityMatcher_match(params);
        ...
        J.set$innerHtml$x(this.activityNamePanel, J.get$name$x(pattern));
      } catch (exception) {
        t1 = H.unwrapException(exception);
        e0 = t1;
        trace = H.getTraceFromException(exception);
        window.alert(H.S(e0) + " " + H.S(trace));
      }
    }, "call$1", "get$handle", 2, 0, 8]
  },
  main_closure: {
    "^": "Closure:6;",
    call$1: function(pattern) {
      return J.matches$1$x(pattern, new S.AxesData(new S.AxisDataParams(9.5, 1.3), new S.AxisDataParams(9.5, 0.3), new S.AxisDataParams(9.5, 9.8)));
    }
  }
},
1],
...
["dart.async", "dart:async", , P, {
  ...
  }, null, "call$2", "call$1", "_nullErrorHandler$closure", 2, 2, 11, 0],
  ...
  _Future__propagateToListeners_handleWhenCompleteCallback_closure0: {
    "^": "Closure:12;_async$_box_0,_captured_result_12",
    call$2: function(error, stackTrace) {
...
["dart.convert", "dart:convert", , P, {
  ...
  }, "call$1", "_defaultToEncodable$closure", 2, 0, 24],
  Codec: {
    "^": "Object;"
  },
  Converter: {
  ...
  _JsonStringifier_writeMap_closure: {
    "^": "Closure:16;_convert$_box_0,_captured_this_1",
...
["dart.dom.html", "dart:html", , W, {
  ...
  EventTarget: {
    ...
    $isEventTarget: 1,
    "%": "MediaStream|MediaStreamTrack|TextTrack;EventTarget"
  },
  FieldSetElement: {
    "^": "HtmlElement;name=",
    "%": "HTMLFieldSetElement"
  ...
  _ElementEventStreamImpl_matches_closure: {
    "^": "Closure:2;_captured_selector_0",
  ...
  _ElementEventStreamImpl_matches_closure0: {
    "^": "Closure:2;_captured_selector_1",
    call$1: function(e) {
  ...
  _StreamPool_add_closure: {
    ...
    call$0: function() {
      var subscription = this._html$_captured_this_0._subscriptions.remove$1(0, this._captured_stream_1);
  ...
  _Html5NodeValidator: {
    ...
    static: {_Html5NodeValidator$: function(uriPolicy) {
        ...
        return true;
      }, "call$4", "_Html5NodeValidator__standardAttributeValidator$closure", 8, 0, 27], _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
        var t1, t2, t3, t4, t5;
        ...
        if (!t1)
          ...
          t1 = true;
        return t1;
      }, "call$4", "_Html5NodeValidator__uriAttributeValidator$closure", 8, 0, 27]}
  },
  ImmutableListMixin: {
    "^": "Object;",
    get$iterator: function(receiver) {
  ...
  _ValidatingTreeSanitizer_sanitizeTree_walk: {
    "^": "Closure:19;_html$_captured_this_0",
...
J.get$accelerationIncludingGravity$x = function(receiver) {
  return J.getInterceptor$x(receiver).get$accelerationIncludingGravity(receiver);
};
...
}, "undefinedLiteralPropertyPattern", "ActivityMatcher_activityPatterns", "get$ActivityMatcher_activityPatterns", function() {
  return [new S.RunningPattern("running", S.AxisDataParams$(2.8987123028039465, 34.238), S.AxisDataParams$(3.1576390575661892, 39.217), S.AxisDataParams$(1.9150973507819982, 38.891999999999996)), new S.JumpingPattern("jumping", S.AxisDataParams$(2.9940119760479043, 24.728), S.AxisDataParams$(1.7003188097768331, 39.217), S.AxisDataParams$(2.5, 38.729)), new S.WalkingPattern("walking", S.AxisDataParams$(2.0268748592448014, 16.147000000000002), S.AxisDataParams$(6.831476025788822, 12.669), S.AxisDataParams$(5.457664119756744, 12.812999999999999)), new S.StayingPattern("staying", S.AxisDataParams$(9.973310858266611, 13.972), S.AxisDataParams$(8.962488129154796, 12.813), S.AxisDataParams$(8.504398826979472, 14.432)), new S.SittingPattern("sitting", S.AxisDataParams$(7.07, 17.69), S.AxisDataParams$(7.83, 11.17), S.AxisDataParams$(2.9, 28.72)), new S.UnknownPattern("unknown", S.AxisDataParams$(0, 0), S.AxisDataParams$(0, 0), S.AxisDataParams$(0, 0))];
}, "activityPatterns", "_AsyncRun_scheduleImmediateClosure", "get$_AsyncRun_scheduleImmediateClosure", function() {
...
{func: "", args: [P.String]},
{func: "", args: [,,]},
{func: "", args: [S.ActivityPattern]},
{func: "", void: true, args: [W.Event]},
{func: "", void: true, args: [W.DeviceMotionEvent]},
...
//# sourceMappingURL=activity_detector.js.map
